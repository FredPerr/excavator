...
type Login = (args: { email: string; password: string }) => Promise<ClientUser>

type Logout = () => Promise<void>

type AuthContext<T = ClientUser> = {
  create: Create
...
type UseAuth<T = ClientUser> = () => AuthContext<T>
export const useAuth: UseAuth = () => {
  if (!process.env.NEXT_PUBLIC_SERVER_URL)
    throw new Error(
      "The environment variable NEXT_PUBLIC_SERVER_URL must be set to use the useAuth hook"
    )
